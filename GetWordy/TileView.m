...
-(instancetype)initWithLetter:(NSString*)letter andSideLength:(float)sideLength
{
    ...
    if (self != nil) {
        ...
        //Creates audio for each tile
        self.audioController = [[AudioController alloc] init];
        [self.audioController preloadAudioEffects: kLetterEffectFiles];
    }
...
{
    //Plays the letter sound file when touched
    NSString *let = self.letter;
